...
namespace Tecnologia
{
    public partial class PrincipalForm
    {
        ...
        private void PrepararTela()
        {
            ...
            Redondear(btnOrdens);
            Redondear(btnPecas);
            Redondear(btnCadastros);
            Redondear(btnPerfil);
            Redondear(btnSair);
            Redondear(btnClientes);
            Redondear(btnAparelhos);
            Redondear(btnUsuarios);
            Redondear(btnNova);
            Redondear(btnAbertas);
            Redondear(btnManutencao);
            Redondear(btnConcluidas);
            Redondear(btnProntas);
        ...
        private void Cadastros_Click(object sender, EventArgs e) { MostrarCadastros(); }
    }
}
